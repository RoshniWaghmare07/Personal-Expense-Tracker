...
public class MainController {
    ...
    public String addExpense(Model model){
        ...
        model.addAttribute("expenseDTO", new ExpenseDTO());// expense to expenseDTO
    ...
    public String showUpdate(@RequestParam("expId") int id, Model model, RedirectAttributes redirectAttributes){
    ...
    public String update(@RequestParam("expenseId") int id, 
        ...
        return "redirect:/list"; // Redirect to the list page after updating
    }
